        ...
        <div class="table-wrap">
            <table>
                ...
                <?php while ($u = $users->fetch_assoc()):
                    $initials = implode('', array_map(fn($w) => mb_substr($w,0,1), array_slice(explode(' ', $u['full_name']), 0, 2)));
                ?>
                <tr>
                    <td>
                        <div class="user-cell">
                            ...
                            <div>
                                <div class="user-cell-name"><?= e($u['full_name']) ?></div>
                                <div class="user-cell-handle">@<?= e($u['username']) ?></div>
                            </div>
                        </div>
                    </td>
